...
.section .data
a:.word 2	@32-bit bariable a in memory
...
ldr r2,=b	@load the memory address ob into r2
ldr r2,[r2]	@load the value b into r2
add r1,r1,r2	@add r1 ro r2 and store into r1
ldr r2, =c	@load the memory address of c into r2
str r1,[r2]	@store r1 into memory c

mov r7,#1	@Program Termination: exit syscall
svc #0		@Program Terminatiom: wake kernel
.end
